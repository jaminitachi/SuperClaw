> Vendored from [ponytail](https://github.com/DietrichGebert/ponytail) for ULW dependency-avoidance — "you think you need X → platform ships Y" lookup table.
> Original work © 2026 DietrichGebert, MIT License. Retained per MIT terms.
